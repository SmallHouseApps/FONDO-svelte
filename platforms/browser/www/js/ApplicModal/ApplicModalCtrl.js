(function (global, factory) {
    ...
    var stateinfoOptions;
    var infoOptions = localStorage.getItem('infoOptions') ? JSON.parse(localStorage.getItem('infoOptions')) : [{
        label: 'Адрес',
        key: 'address',
        preview: true
    }, {
    ...
    async function preloader(){
        ...
        var dotsSpan = document.getElementsByClassName('option-data');
        for(var i = 0; i < dotsSpan.length; i++){
            dotsSpan[i].parentNode.parentNode.style.setProperty('height', (dotsSpan[i].clientHeight - 21)+'px');
        }

        var cards = document.getElementById('ApplicModalComponent').querySelectorAll('.card');
    ...
    var ApplicModalCtrl = new SvelteController(ApplicModalComponent, {
        ...
        methods: [{
            ...
            function: () => {
                ...
                requirejs(['slip'], function(){
                    ...
                    function reorder(e){
                        var movedItem = stateinfoOptions[e.detail.originalIndex - 1];
            ...
            function: async el => {
                if(el.parentNode.querySelector('.content-to-show').offsetHeight > 0){
                    ...
                    var height = el.parentNode.querySelector('.content-to-show').querySelector('.hiden-content').offsetHeight + 20;
