(function (global, factory) {
    ...
    let workShift = localStorage.getItem('workShift') ? JSON.parse(localStorage.getItem('workShift')) : { open: false };
                ...
                if(results.buttonIndex == 1){
                    if(results.input1 == ''){
                        ...
                        if(parseInt(results.input1)){
                            ...
                            let h = new Date(workShift.timestamp_start).getHours(); h = h < 10 ? ( '0' + h ) : h;
                            let m = new Date(workShift.timestamp_start).getMinutes(); m = m < 10 ? ( '0' + m ) : m;
                ...
                if(results.buttonIndex == 1){
                    if(results.input1 == ''){
                        ...
                        if(parseInt(results.input1)){
                            ...
                            let h = new Date(workShift.timestamp_end).getHours(); h = h < 10 ? ( '0' + h ) : h;
                            let m = new Date(workShift.timestamp_end).getMinutes(); m = m < 10 ? ( '0' + m ) : m;
