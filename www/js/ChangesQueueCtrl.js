(function (global, factory) {
    ...
    let queu = localStorage.getItem('ChangesQueue') ? JSON.parse(localStorage.getItem('ChangesQueue')) : [];
    ...
    let checkConnection = setInterval(function(){
        if(queu.length > 0){
            if(navigator.onLine){
                let change = queu.shift();
                let requestData = {}; let url;
